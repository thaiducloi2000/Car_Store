                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="Data Source=.;Initial Catalog=Car;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT TOP (3) Username, Password, RoleID, Fullname, DOB, Address, Email, Img FROM Account"></asp:SqlDataSource>
                                        <br />
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CarConnectionString %>" SelectCommand="SELECT ProId, ProName, Price, Status, ImgUrl, Description, CategoryId, Quantity from [Product] WHERE Status = 'Available'"></asp:SqlDataSource>
                                            <br />
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <br />
                                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="Data Source=.;Initial Catalog=Car;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT TOP (3) OrderId, OrderDate, Username, Status, Total, Address, PaymentId FROM [Order] ORDER BY OrderDate DESC"></asp:SqlDataSource>
