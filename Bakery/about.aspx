...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="container">
            <div class="row fullscreen d-flex justify-content-center align-items-center">
                <div class="banner-content col-lg-10 col-md-12 justify-content-center">
                    <h6 class="text-uppercase">Whenever you need car</h6>
                    <h1>About us			
                    </h1>
    ...
    <section class="home-about-area section-gap">
        ...
        <img class="about-img" width="500" height="250" src="img/contact.png" alt="about-img">
    </section>
    <!-- End home-about Area -->
    ...
    <section class="about-video-area section-gap">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 justify-content-center align-items-center d-flex" style="background: url(../img/video-picture.jpg) no-repeat center;background-size: cover;height: 330px">
                    <a class="play-btn" href="https://www.youtube.com/watch?v=fKNdoxRld34">
