...
<%--                                        <label>
                                        ...
                                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:CarConnectionString %>" SelectCommand="SELECT ProId, ProName, Price, Status, ImgUrl, Description, CategoryId, Quantity from [Product] WHERE Status = 'Available'"></asp:SqlDataSource>
                                        <br />
                                    </div>
                                </div>
                            </div>
